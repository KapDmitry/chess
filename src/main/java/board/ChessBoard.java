...
public class ChessBoard {
    ...
    public boolean castling0() {
        if (nowPlayer.equals("White")) {
            ...
            if (king.isUnderAttack(this,0,4)) return false;
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K")
                    && board[0][1] == null && board[0][2] == null && board[0][3] == null) {
                if (board[0][0].getColor().equals("Whhite") && board[0][4].getColor().equals("White") &&
            ...
            if (king.isUnderAttack(this,7,4)) return false;
